  ...
  return (
    <div className="space-y-8">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900">Resumo Financeiro</h1>
          <p className="text-slate-500">Acompanhe a saúde da sua empresa no período.</p>
        </div>
        ...
        <div className="flex items-center gap-2 bg-white p-2 rounded-xl border border-slate-200 shadow-sm">
          ...
          <input
            ...
            className="text-sm font-semibold text-slate-700 bg-transparent border-none focus:ring-0 outline-none p-1"
          />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-sm font-semibold text-slate-500 uppercase tracking-wider">Entradas</span>
          </div>
          <p className="text-2xl font-bold text-slate-900">{formatCurrency(totalIn)}</p>
          <p className="text-xs text-emerald-600 font-medium mt-1">Realizado no período</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-sm font-semibold text-slate-500 uppercase tracking-wider">Saídas</span>
          </div>
          <p className="text-2xl font-bold text-slate-900">{formatCurrency(totalOut)}</p>
          <p className="text-xs text-rose-600 font-medium mt-1">Realizado no período</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-sm font-semibold text-slate-500 uppercase tracking-wider">Saldo Atual</span>
          </div>
          <p className="text-2xl font-bold text-slate-900">{formatCurrency(currentBalance)}</p>
          <p className="text-xs text-indigo-600 font-medium mt-1">Acumulado até o fim do período</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-sm font-semibold text-slate-500 uppercase tracking-wider">Provisões</span>
          </div>
          <p className="text-2xl font-bold text-slate-900">{formatCurrency(pendingIn - pendingOut)}</p>
          <p className="text-xs text-orange-600 font-medium mt-1">Previsto para o período</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
          <h3 className="text-lg font-bold text-slate-900 mb-6">Entradas vs Saídas (Realizado)</h3>
          <div className="h-80">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
          <h3 className="text-lg font-bold text-slate-900 mb-6">Fluxo de Caixa Acumulado</h3>
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
